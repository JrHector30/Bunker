                    ...
                    <div className="user-selector" ref={dropdownRef} style={{ position: 'relative', marginBottom: 40 }}>
                        ...
                        >
                            <div style={{ display: 'flex', alignItems: 'center', gap: 15 }}>
                                ...
                                <div>
                                    <div style={{ fontWeight: 500, fontSize: '1.05rem', color: '#fff', marginBottom: 4 }}>{selectedUser ? selectedUser.name : 'Select user'}</div>
                                    <div style={{ fontSize: '0.8rem', color: '#666', fontWeight: 400 }}>{selectedUser ? selectedUser.shift : ''}</div>
                                </div>
                            </div>
