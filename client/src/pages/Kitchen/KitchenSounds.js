...
// It requires NO external files (.mp3, .wav) and runs flawlessly offline.
// AudioContext is initialized perezosamente (lazily) upon first user interaction to comply with autoplay block policies.
