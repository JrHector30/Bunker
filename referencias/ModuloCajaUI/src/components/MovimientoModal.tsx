          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <div>
              ...
              <div className="relative rounded-lg">
                ...
                <input
                  ...
                  className={`block w-full rounded-lg border py-2.5 pl-9 pr-3 text-sm focus:outline-hidden transition-all ${
                    errors.monto
            ...
            <div>
              ...
              <textarea
                ...
                className={`block w-full rounded-lg border p-3 text-sm focus:outline-hidden transition-all resize-none ${
                  errors.descripcion
                    ? 'border-rose-300 bg-rose-50/50 text-rose-900 focus:border-rose-500'
                    : 'border-slate-200 text-slate-900 focus:border-slate-800'
                }`}
